...
(11)	Add the ladder to the first lane of each row by combining 2ul of the ladder with 2ul of dye. If ladder comes mixed with loading dye (it is not clear), then just add 2ul of the ladder.
